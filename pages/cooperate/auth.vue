  ...
  <div>
    ...
    <div class="auth">
      <aside class="aside">
        ...
        <a href="javascript:;" class="active">渠道合作伙伴认证</a>
        <a href="javascript:;">专业化认证</a>
      </aside>
      <div class="content">
        <header>
          <h1>渠道合作伙伴认证</h1>
              ...
              <div class="group">
                ...
                <el-col :span="12">
                  <el-form-item prop="registeredCapital">
                    <el-input v-model="form.registeredCapital" placeholder="注册资金*"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="establishTime">
                    <el-input v-model="form.establishTime" placeholder="成立时间*"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="unifiedSocialCreditCode">
                    <el-input v-model="form.unifiedSocialCreditCode" placeholder="统一社会信用代码*"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="officeAddress">
                    <el-input v-model="form.officeAddress" placeholder="办公地址*"></el-input>
                  </el-form-item>
                </el-col>
              </div>
              <div class="group">
                ...
                <el-col :span="12">
                  <el-form-item prop="legalRepresentative">
                    <el-input v-model="form.legalRepresentative" placeholder="公司法人代表姓名*"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="contacts">
                    <el-input v-model="form.contacts" placeholder="日常联系人姓名*"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="phone">
                    <el-input v-model="form.phone" placeholder="公司法人代表手机号*"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="contactPhone">
                    <el-input v-model="form.contactPhone" placeholder="日常联系人手机号*"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="email">
                    <el-input v-model="form.email" placeholder="公司法人代表邮箱*"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item prop="contactEmail">
                    <el-input v-model="form.contactEmail" placeholder="日常联系人邮箱*"></el-input>
                  </el-form-item>
                </el-col>
              </div>
                ...
                <el-col :span="6">
                  <el-form-item prop="IDBackPicture">
                    <el-upload
                      ...
                      :before-upload="beforeAvatarUpload"
                    >
                      <img v-if="imageUrlIDBackPicture" :src="imageUrlIDBackPicture" class="avatar" />
                      <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                    </el-upload>
                  </el-form-item>
                </el-col>
