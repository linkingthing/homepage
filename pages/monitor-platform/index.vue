  ...
  <div class="monitor-platform">
    ...
    <section class="section-1 platform-section">
      ...
      <div class="section-1-content">
        <p>
          IPv6规模部署工作时间紧、任务重、跨度长、技术性强。在整个IPv6代际升迁的过程中，需要承担诸多职责、满足各种需求。必须时刻掌控持续变化的动态的网络状况，以提出安全、简单而灵活的应对方案和解决方案。所有的这一切，都必须是基于对当前IPv6发展状况的了解。CLXOne IPv6发展监测平台使您更智慧更安全的开展工作。
        </p>
...
并最终形成中国IPv6发展监测体系`
        },
        {
          img: src3,
          title: "海南IPv6发展监测平台",
          content: `海南IPv6发展监测平台通过主动监测采集海南省内IPv6基础资源、网络基础设施、应用基础设施、互联网应用、IPv6用户等信息，客观、准确、全面的反映当前海南IPv6发展现状，为推进IPv6规模部署提供必要的依据，并最终形成海南IPv6发展监测体系`
        },
        {
          img: src4,
